...
func TestGetBuildInfo_travis(t *testing.T) {
	...
	os.Setenv("TRAVIS_REPO_SLUG", "khulnasoft/codebase")
...
func TestGetBuildInfo_circleci(t *testing.T) {
	...
	os.Setenv("CIRCLE_PROJECT_USERNAME", "khulnasoft")
	if _, _, err := GetBuildInfo(); err == nil {
		t.Error("error expected but got nil")
	} else {
		t.Log(err)
	...
	os.Setenv("CIRCLE_PROJECT_REPONAME", "codebase")
	if _, _, err := GetBuildInfo(); err == nil {
		t.Error("error expected but got nil")
	} else {
		t.Log(err)
...
func TestGetBuildInfo_droneio(t *testing.T) {
	...
	os.Setenv("DRONE_REPO_OWNER", "khulnasoft")
	if _, _, err := GetBuildInfo(); err == nil {
		t.Error("error expected but got nil")
	} else {
		t.Log(err)
	...
	os.Setenv("DRONE_REPO_NAME", "codebase")
	if _, _, err := GetBuildInfo(); err == nil {
		t.Error("error expected but got nil")
	} else {
		t.Log(err)
...
func TestGetBuildInfo_common(t *testing.T) {
	...
	os.Setenv("CI_REPO_OWNER", "khulnasoft")
	if _, _, err := GetBuildInfo(); err == nil {
		t.Error("error expected but got nil")
	} else {
		t.Log(err)
	...
	os.Setenv("CI_REPO_NAME", "codebase")
	if _, _, err := GetBuildInfo(); err == nil {
		t.Error("error expected but got nil")
	} else {
		t.Log(err)
