...
3. Attach a label [`bump:patch`, `bump:minor`, or `bump:major`]. codebase uses [haya14busa/action-bumpr](https://github.com/haya14busa/action-bumpr).
4. [The release workflow](./workflows/release.yml) automatically tag a
   ...
   Pull Request.
5. Check the release workflow and verify the release. [![release](https://github.com/khulnasoft/codebase/workflows/release/badge.svg)](https://github.com/khulnasoft/codebase/actions?query=workflow%3Arelease)
...
2. Create a release branch (`release-v{major}.{minor}`) based on the latest semver release `v{major}.{minor}.{patch}` if there is no exisisting release branch.
  - You need write permission to codebase repository to push the release branch.
...
7. Check the release workflow and verify the release. [![release](https://github.com/khulnasoft/codebase/workflows/release/badge.svg)](https://github.com/khulnasoft/codebase/actions?query=workflow%3Arelease)
