...
type CheckResponse struct {
	...
	// filled when ReportURL is not available. i.e. codebase doesn't have write
	// permission to Check API.
	// It's also not expected to be passed over network via JSON.
	// TODO(khulnasoft): Consider to move this type to this package to avoid
	// (cyclic) import.
	// Optional.
...
type Annotation struct {
	...
	// Deprecated fields below. Need to support them for the old codebase CLI
	// version.
