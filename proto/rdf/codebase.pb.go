// Codebase Diagnostic Format
//
// Codebase Diagnostic Format defines generic machine readable message
...
// development tools (e.g. editors, codebase, etc..) communicate.
//
...
func (Severity) Descriptor() protoreflect.EnumDescriptor {
	return file_codebase_proto_enumTypes[0].Descriptor()
}

func (Severity) Type() protoreflect.EnumType {
	return &file_codebase_proto_enumTypes[0]
}
...
//	^--- insert '15'
//
// Update example ('haya15busa' -> 'sulaiman-coder'):
//
//	range {
//	  start {
//	    line: 1
...
var file_codebase_proto_rawDesc = []byte{
...
var (
	...
	file_codebase_proto_rawDescData = file_codebase_proto_rawDesc
)

func file_codebase_proto_rawDescGZIP() []byte {
	file_codebase_proto_rawDescOnce.Do(func() {
		file_codebase_proto_rawDescData = protoimpl.X.CompressGZIP(file_codebase_proto_rawDescData)
	})
	return file_codebase_proto_rawDescData
}

var file_codebase_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_codebase_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_codebase_proto_goTypes = []interface{}{
	(Severity)(0),            // 0: codebase.rdf.Severity
	(*DiagnosticResult)(nil), // 1: codebase.rdf.DiagnosticResult
	(*Diagnostic)(nil),       // 2: codebase.rdf.Diagnostic
	(*Location)(nil),         // 3: codebase.rdf.Location
	(*Range)(nil),            // 4: codebase.rdf.Range
	(*Position)(nil),         // 5: codebase.rdf.Position
	(*Suggestion)(nil),       // 6: codebase.rdf.Suggestion
	(*Source)(nil),           // 7: codebase.rdf.Source
	(*Code)(nil),             // 8: codebase.rdf.Code
}
var file_codebase_proto_depIdxs = []int32{
	2,  // 0: codebase.rdf.DiagnosticResult.diagnostics:type_name -> codebase.rdf.Diagnostic
	7,  // 1: codebase.rdf.DiagnosticResult.source:type_name -> codebase.rdf.Source
	0,  // 2: codebase.rdf.DiagnosticResult.severity:type_name -> codebase.rdf.Severity
	3,  // 3: codebase.rdf.Diagnostic.location:type_name -> codebase.rdf.Location
	0,  // 4: codebase.rdf.Diagnostic.severity:type_name -> codebase.rdf.Severity
	7,  // 5: codebase.rdf.Diagnostic.source:type_name -> codebase.rdf.Source
	8,  // 6: codebase.rdf.Diagnostic.code:type_name -> codebase.rdf.Code
	6,  // 7: codebase.rdf.Diagnostic.suggestions:type_name -> codebase.rdf.Suggestion
	4,  // 8: codebase.rdf.Location.range:type_name -> codebase.rdf.Range
	5,  // 9: codebase.rdf.Range.start:type_name -> codebase.rdf.Position
	5,  // 10: codebase.rdf.Range.end:type_name -> codebase.rdf.Position
	4,  // 11: codebase.rdf.Suggestion.range:type_name -> codebase.rdf.Range
...
func file_codebase_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_codebase_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codebase_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codebase_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codebase_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Range); i {
			case 0:
				return &v.state
			case 1:
		...
		file_codebase_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codebase_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codebase_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Source); i {
			case 0:
				return &v.state
			case 1:
		...
		file_codebase_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Code); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_codebase_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		...
		EnumInfos:         file_codebase_proto_enumTypes,
		MessageInfos:      file_codebase_proto_msgTypes,
	}.Build()
	File_codebase_proto = out.File
	file_codebase_proto_rawDesc = nil
