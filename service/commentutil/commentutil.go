...
func (p PostedComments) IsPosted(c *codebase.Comment, lineNum int, body string) bool {
...
const BodyPrefix = `<sub>reported by [codebase](https://github.com/khulnasoft/codebase) :dog:</sub><br>`

// MarkdownComment creates comment body markdown.
func MarkdownComment(c *codebase.Comment) string {
...
func toolName(c *codebase.Comment) string {
...
func severity(c *codebase.Comment) string {
